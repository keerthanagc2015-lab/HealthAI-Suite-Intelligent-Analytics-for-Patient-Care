"""
HealthAI - ClinicalBERT NER Evaluation

Purpose:
    Evaluate the fine-tuned ClinicalBERT NER model on the
...
Training:
    Fine-tuning was completed in Google Colab using a T4 GPU.

Evaluation:
    Performed locally in the HealthAI development environment.
"""
...
EXPECTED_TEST_DOCUMENTS = 60

EXPECTED_TOKEN_ACCURACY = 0.7714
EXPECTED_ENTITY_PRECISION = 0.3687
EXPECTED_ENTITY_RECALL = 0.4408
EXPECTED_ENTITY_F1 = 0.4016
...
print("=" * 70)
print("HEALTHAI - CLINICALBERT NER EVALUATION")
print("=" * 70)
...
if not MODEL_PATH.exists():
    raise FileNotFoundError(
        f"ClinicalBERT model not found:\n{MODEL_PATH}"
    )
...
print("✓ ClinicalBERT model found.")
...
print(
    f"Number of labels: {len(label2id)}"
)

print(
    f"Number of entity types: "
    f"{len(entity_labels)}"
)
...
if len(chunks) != EXPECTED_CHUNKS:
    ...
    print(
        f"WARNING: Expected {EXPECTED_CHUNKS} chunks "
...
if len(unique_documents) != EXPECTED_DOCUMENTS:
    ...
    raise ValueError(
        ...
        f"but found {len(unique_documents)}."
    )


# ============================================================
# 11. SAME DOCUMENT-LEVEL SPLIT
# ============================================================
...
if len(test_documents) != EXPECTED_TEST_DOCUMENTS:

    raise ValueError(
        "Unexpected test document count."
    )


# ============================================================
# 12. SELECT TEST CHUNKS
# ============================================================
...
# ============================================================
# 13. LOAD CLINICALBERT TOKENIZER
# ============================================================
...
print()
print("=" * 70)
print("RUNNING CLINICALBERT EVALUATION")
print("=" * 70)
...
if total_valid_tokens == 0:
    ...
    raise RuntimeError(
        "No valid tokens found during evaluation."
    )
...
print()
print("=" * 70)
print("CLINICALBERT NER TEST RESULTS")
print("=" * 70)
...
comparison_path = (
    OUTPUT_DIR
    / "clinicalbert_vs_colab_evaluation_comparison.csv"
)
...
print()
print("=" * 70)
print("CLINICALBERT NER EVALUATION COMPLETED")
print("=" * 70)
